...
public class comune_monitor_event_severity extends BaseHandler implements TriggerableActivityBehavior {

    private static Logger logger = LoggerFactory.getLogger(comune_monitor_event_severity.class);

    String evolution_predicate = "assessed_event_severity(comune)";
