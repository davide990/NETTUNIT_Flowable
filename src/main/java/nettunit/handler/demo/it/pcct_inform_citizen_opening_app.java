...
public class pcct_inform_citizen_opening_app extends BaseHandler implements TriggerableActivityBehavior {

    private static Logger logger = LoggerFactory.getLogger(pcct_inform_citizen_opening_app.class);
