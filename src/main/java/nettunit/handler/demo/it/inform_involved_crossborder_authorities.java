...
public class inform_involved_crossborder_authorities extends BaseHandler implements TriggerableActivityBehavior {

    private static Logger logger = LoggerFactory.getLogger(inform_involved_crossborder_authorities.class);

    String evolution_predicate = "involved_crossborder_authorities";
...
//        JixelEvent evt = (JixelEvent) delegateExecution.getVariable(JIXEL_EVENT_VAR_NAME);
    ...
    public void execute(DelegateExecution execution) {
        ...
        // Launch MUSA->NewGoal(managing_emergency_tn)
