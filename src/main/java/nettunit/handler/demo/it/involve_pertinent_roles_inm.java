...
public class involve_pertinent_roles_inm extends BaseHandler implements TriggerableActivityBehavior {

    private static Logger logger = LoggerFactory.getLogger(involve_pertinent_roles_inm.class);
