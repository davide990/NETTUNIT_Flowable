...
public class comune_inform_citizen_opening_sirens extends BaseHandler implements TriggerableActivityBehavior {

    private static Logger logger = LoggerFactory.getLogger(comune_inform_citizen_opening_sirens.class);
    ...
    public void execute(DelegateExecution execution) {
        ...
        musaService.updateEventDescription(evt, "*Attivazione sirene per comunicazione ai cittadini dell'emergenza.");
        this.getMusaRabbitMQConsumerService().save(evt, taskID);
