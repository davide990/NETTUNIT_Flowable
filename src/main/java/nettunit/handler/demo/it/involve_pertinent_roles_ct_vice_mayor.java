...
public class involve_pertinent_roles_ct_vice_mayor extends BaseHandler implements TriggerableActivityBehavior {

    private static Logger logger = LoggerFactory.getLogger(involve_pertinent_roles_ct_vice_mayor.class);

    String evolution_predicate = "involved_pertinent_bodies(ct_mayor)";
    ...
    public void execute(DelegateExecution execution) {
        ...
        recipients.addOne(JixelDomainInformation.DEPUTY_MAYOR);
