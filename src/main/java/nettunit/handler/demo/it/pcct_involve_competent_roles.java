...
public class pcct_involve_competent_roles extends BaseHandler {

    private static Logger logger = LoggerFactory.getLogger(pcct_involve_competent_roles.class);
    ...
    public void execute(DelegateExecution execution) {
        ...
        recipients.addOne(JixelDomainInformation.COMUNE_CATANIA_POLIZIA_MUNICIPALE);
