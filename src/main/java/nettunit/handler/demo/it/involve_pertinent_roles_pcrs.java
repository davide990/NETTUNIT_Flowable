...
public class involve_pertinent_roles_pcrs extends BaseHandler implements TriggerableActivityBehavior {

    private static Logger logger = LoggerFactory.getLogger(involve_pertinent_roles_pcrs.class);

    String evolution_predicate = "involved_pertinent_bodies(pcrs)";
