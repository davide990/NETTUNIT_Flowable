...
public class ariana_involve_competent_roles extends BaseHandler {

    private static Logger logger = LoggerFactory.getLogger(ariana_involve_competent_roles.class);
