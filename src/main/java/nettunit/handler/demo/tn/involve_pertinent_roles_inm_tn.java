...
public class involve_pertinent_roles_inm_tn extends BaseHandler implements TriggerableActivityBehavior {

    private static Logger logger = LoggerFactory.getLogger(involve_pertinent_roles_inm_tn.class);

    String evolution_predicate = "involved_pertinent_bodies(inm)";
