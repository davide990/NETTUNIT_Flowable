...
public class regions_tn_monitor_event_severity extends BaseHandler {

    private static Logger logger = LoggerFactory.getLogger(regions_tn_monitor_event_severity.class);
