...
public class update_airborne_dispersion_data_tn extends BaseHandler {

    private static Logger logger = LoggerFactory.getLogger(update_airborne_dispersion_data_tn.class);
    ...
    public void execute(DelegateExecution execution) {
        ...
        musaService.updateEventDescription(evt, "*interpretazione dei risultati del modello* [INM]");
