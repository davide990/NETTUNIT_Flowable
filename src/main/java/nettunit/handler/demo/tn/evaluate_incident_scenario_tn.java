...
public class evaluate_incident_scenario_tn extends BaseHandler {

    private static Logger logger = LoggerFactory.getLogger(evaluate_incident_scenario_tn.class);
