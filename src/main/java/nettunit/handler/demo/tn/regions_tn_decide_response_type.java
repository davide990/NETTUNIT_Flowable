...
public class regions_tn_decide_response_type extends BaseHandler {

    private static Logger logger = LoggerFactory.getLogger(regions_tn_decide_response_type.class);
