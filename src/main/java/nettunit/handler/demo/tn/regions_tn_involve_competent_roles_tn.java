...
public class regions_tn_involve_competent_roles_tn extends BaseHandler {

    private static Logger logger = LoggerFactory.getLogger(regions_tn_involve_competent_roles_tn.class);
