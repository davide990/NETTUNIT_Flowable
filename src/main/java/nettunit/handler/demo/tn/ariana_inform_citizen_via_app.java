...
public class ariana_inform_citizen_via_app extends BaseHandler {

    private static Logger logger = LoggerFactory.getLogger(ariana_inform_citizen_via_app.class);
