...
public class ask_for_airborne_dispersion_estimate_tn extends BaseHandler {

    private static Logger logger = LoggerFactory.getLogger(ask_for_airborne_dispersion_estimate_tn.class);
