...
public class ask_for_health_risk_estimate_tn extends BaseHandler {

    private static Logger logger = LoggerFactory.getLogger(ask_for_health_risk_estimate_tn.class);
