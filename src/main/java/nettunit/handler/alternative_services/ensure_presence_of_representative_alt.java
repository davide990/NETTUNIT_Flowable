...
public class ensure_presence_of_representative_alt implements JavaDelegate {

    private static Logger logger = LoggerFactory.getLogger(ensure_presence_of_representative_alt.class);
