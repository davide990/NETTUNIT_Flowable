...
public class do_crossborder_communication_alt implements JavaDelegate {

    private static Logger logger = LoggerFactory.getLogger(do_crossborder_communication_alt.class);
