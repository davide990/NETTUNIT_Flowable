...
public class keep_update_involved_personnel_alt implements JavaDelegate {

    private static Logger logger = LoggerFactory.getLogger(keep_update_involved_personnel_alt.class);
